...
import com.example.demo.Aree_Verdi.Services.JwtRequestFilter;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http
            ...
            .authorizeHttpRequests(auth -> {
                ...
                auth.requestMatchers("/farmacie/getAll").permitAll();  // Permetti l'accesso libero a /farmacie/getAll
